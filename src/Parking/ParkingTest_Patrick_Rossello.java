    ...
    public static void main(String[] args) {
       ...
       do {
           ...
           try {
               ...
               System.out.println(parking.getPlacesOcupades(Parkingv3_Patrick_Rossello.TipusPlacesParking.No_Discapacitat)+ " " +parking.getPlacesOcupades(Parkingv3_Patrick_Rossello.TipusPlacesParking.Discapacitat) );
               System.out.println(parking.getPlacesLliures(Parkingv3_Patrick_Rossello.TipusPlacesParking.No_Discapacitat)+ " " +parking.getPlacesLliures(Parkingv3_Patrick_Rossello.TipusPlacesParking.Discapacitat));
